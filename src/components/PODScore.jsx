// src/components/PODScore.jsx
import React, { useState, useEffect } from 'react';
import { useTranslation } from 'react-i18next';
import PODViewMode from './ScoreCard/PODViewMode';
import PODEditMode from './ScoreCard/PODEditMode';
import '../i18n/i18n';
import { characters } from '../data/characters';
import podPresets from './ScoreCard/podPresets.json';
    ...
    <div className="min-h-screen bg-gray-950 text-white p-4">
      ...
      <div className="fixed top-4 right-4 z-50 space-y-2">
        {tankMessages.map(msg => (
          <div key={msg.id} className="bg-red-900/90 text-white px-4 py-2 rounded-lg shadow-lg animate-fade-in">
            {msg.message}
          </div>
        ))}
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-red-700 to-red-900 rounded-t-xl p-3 sm:p-4">
          {/* Desktop Header */}
