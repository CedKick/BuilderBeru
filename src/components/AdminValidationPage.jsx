// AdminValidationPage.jsx - 🛡️ ADMIN VALIDATION SYSTEM ULTIMATE BY KAISEL
...
const AdminValidationPage = ({ 
  ...
  const loadPendingHunters = async () => {
    try {
      setLoading(true);
      showTankMessage("🛡️ Chargement des hunters en attente...", true, 'kaisel');
      ...
      if (response.ok && result.success) {
        ...
        showTankMessage(`🛡️ ${result.hunters.length} hunters en attente de validation`, true, 'kaisel');
      } else {
  ...
  const handleApprove = async (hunterId, confidenceLevel, issues = [], adminNotes = '') => {
    try {
      ...
      if (response.ok && result.success) {
        showTankMessage(`✅ ${result.hunter.hunterName} approuvé !`, true, 'kaisel');
  ...
  const handleReject = async (hunterId, reason = 'Non conforme') => {
    if (!window.confirm(`Êtes-vous sûr de vouloir SUPPRIMER définitivement ce hunter ?\n\nRaison: ${reason}`)) {
      return;
    }
    ...
    try {
      ...
      if (response.ok && result.success) {
        showTankMessage(`🗑️ ${result.rejected.hunterName} supprimé`, true, 'kaisel');
        loadPendingHunters(); // Recharger la liste
        setShowDetails(false);
      } else {
  ...
  return (
    <>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-2xl md:text-3xl font-bold text-red-400">
                    Admin Validation Ultimate
                  </h1>
                  <p className="text-gray-300 text-sm">
                    Système de modération Kaisel v2.0 • {pendingHunters.length} en attente
                  </p>
                </div>
              </div>
              ...
              <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-black/30 rounded-lg p-4 border border-purple-500/20">
                    <p className="text-gray-400 text-sm">Taux validation</p>
                    <p className="text-2xl font-bold text-purple-400">{adminStats.validationRate}%</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              {loading ? (
                <div className="flex flex-col items-center justify-center py-20">
                  ...
                  <h3 className="text-xl text-red-400 mb-2">Chargement des validations...</h3>
                  <p className="text-gray-400">Kaisel analyse les soumissions...</p>
                </div>
                    ...
                    {pendingHunters.map((hunter) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Info Hunter */}
                          <div className="mb-4">
                            <h3 className="text-xl font-bold text-white mb-1">{hunter.hunterName}</h3>
      ...
      {/* 🔍 MODAL DÉTAILS VALIDATION ULTIMATE */}
          ...
          <div className="bg-gray-900 rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-y-auto border-2 border-red-500">
            ...
            <div className="p-6 border-b border-red-500/30">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-red-400">🛡️ Validation Détaillée Ultimate</h2>
                  <p className="text-gray-300">{selectedHunter.hunterName} • {selectedHunter.characterName}</p>
                  <p className="text-gray-400 text-sm">
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-black/30 rounded-lg p-4">
                  <h3 className="text-cyan-400 font-bold mb-2">📊 Ratio</h3>
                  ...
                  <p className="text-xs text-gray-400 mt-2">Artifacts/Total</p>
                </div>
              </div>
              ...
              {selectedHunter.screenshots && selectedHunter.screenshots.length > 0 && (
                <div className="mb-6">
                  <h3 className="text-green-400 font-bold mb-4">📸 Screenshots Gallery ({selectedHunter.screenshots.length})</h3>
              ...
              {selectedHunter.setAnalysis && (
                <div className="bg-black/30 rounded-lg p-4 border border-blue-500/20 mb-6">
                  <h3 className="text-blue-400 font-bold mb-4">🎨 Analyse des Sets</h3>
              ...
              {selectedHunter.autoAnalysis?.issues.length > 0 && (
                <div className="mb-6">
                  <h3 className="text-red-400 font-bold mb-4">🚨 Issues Détectées</h3>
              ...
              <div className="border-t border-gray-700 pt-6">
                <h3 className="text-white font-bold mb-4">🎯 Actions de Validation</h3>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <select 
                          ...
                          id="rejectReason"
                        >
                          <option value="Non conforme">Non conforme aux standards</option>
                      ...
                      <div className="bg-red-900/30 rounded p-3">
                        <p className="text-red-300 text-sm">
                          ...
                          Ce hunter sera définitivement supprimé de la base de données.
