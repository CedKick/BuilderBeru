...
currentWeekData = bdgPresets.weeks[selectedWeek];
  ...
  const bossImages = {
    ...
    'architect': 'https://res.cloudinary.com/dbg7m8qjd/image/upload/v1748730843/bot_baruka_irhs7y.png'
  };
 ...
 <div 
  onClick={handleClick}
  className="bg-gray-900/50 rounded-xl overflow-hidden border border-purple-500/50 backdrop-blur-sm cursor-pointer hover:scale-105 transition-transform h-[120px] w-full max-w-[400px] mx-auto flex"
>
  ...
  <div className="relative w-full">
    ...
    <div className="absolute inset-0 p-3 flex flex-col justify-between">
      ...
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-bold text-white">BDG Score</h3>
      ...
      <div>
        ...
        <div className="flex gap-2">
          {currentWeekData.elements && currentWeekData.elements.map(element => (
            <div
              key={element}
              className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold text-white shadow-lg ${elementColors[element]}`}
            >
