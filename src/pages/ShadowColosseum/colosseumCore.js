...
export const SPRITES = {
  kaisel: 'https://api.builderberu.com/cdn/images/Kaisel_face_dm9394.webp',
  tank: 'https://api.builderberu.com/cdn/images/tank_face_n9kxrh.webp',
  nyarthulu: 'https://api.builderberu.com/cdn/images/Nyarthulu_face_vawrrz.webp',
  raven: 'https://api.builderberu.com/cdn/images/Raven_face_xse2x9.webp',
  lil_kaisel: 'https://api.builderberu.com/cdn/images/lil_face_vyjvxz.webp',
  pingsu: 'https://api.builderberu.com/cdn/images/Pingsu_face_tnilyr.webp',
  okami: 'https://api.builderberu.com/cdn/images/Okami_face_qfzt4j.webp',
  alecto: 'https://api.builderberu.com/cdn/images/alecto_face_irsy6q.webp',
  shadow_goblin: 'https://api.builderberu.com/cdn/images/ShadowGobelin_xi9cbs.webp',
  corrupted_wolf: 'https://api.builderberu.com/cdn/images/CorruptedWolf_eytnug.webp',
  stone_golem: 'https://api.builderberu.com/cdn/images/CobbleStone_de1rac.webp',
  fallen_knight: 'https://api.builderberu.com/cdn/images/ChevalierDechu_ruqbx7.webp',
  ancestral_spectre: 'https://api.builderberu.com/cdn/images/SpectreAncestral_vtqpbr.webp',
  salamandre: 'https://api.builderberu.com/cdn/images/Salamandre_oyqyyi.webp',
  griffon: 'https://api.builderberu.com/cdn/images/Griffon_qwiklr.webp',
  guardian: 'https://api.builderberu.com/cdn/images/GardiendesPortails_mthlve.webp',
  chimera: 'https://api.builderberu.com/cdn/images/ChimereAbyssal_illdft.webp',
  phoenix: 'https://api.builderberu.com/cdn/images/Ph%C3%A9nixNoir_cdwoso.webp',
  titan: 'https://api.builderberu.com/cdn/images/TitanDesGlaces_mjtynl.webp',
  monarch: 'https://api.builderberu.com/cdn/images/OmbreMineure_zwqbr3.webp',
  wraith: 'https://api.builderberu.com/cdn/images/Wraith_qgs3bo.webp',
  ifrit: 'https://api.builderberu.com/cdn/images/Ifrit_pl9t6q.webp',
  wyvern: 'https://api.builderberu.com/cdn/images/Wyverne_dzrxk5.webp',
  lich_king: 'https://api.builderberu.com/cdn/images/RoiLiche_xgu6ug.webp',
  banshee: 'https://api.builderberu.com/cdn/images/Banshee_bnwnzn.webp',
  dragon_rouge: 'https://api.builderberu.com/cdn/images/DragonRouge_fvwtzi.webp',
  tempestaire: 'https://api.builderberu.com/cdn/images/Tempestaire_xx926x.webp',
  colossus: 'https://api.builderberu.com/cdn/images/Colossus_xok08m.webp',
  archdemon: 'https://api.builderberu.com/cdn/images/Archdemon_hiem7r.webp',
  ragnarok: 'https://api.builderberu.com/cdn/images/Ragnarok_liihbd.webp',
  zephyr: 'https://api.builderberu.com/cdn/images/ZephyrUltime_xdxvjd.webp',
};
...
export const computeAttack = (attacker, skill, defender, tb = {}) => {
  ...
  if (attacker.isMage && attacker.maxMana) {
    ...
    if (skill.manaScaling) {
      ...
      effAtk = Math.floor(effMana * manaMult);
    }
  }
