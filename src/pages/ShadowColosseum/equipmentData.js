...
export const WEAPONS = {
  // Fire (5)
  w_lame_inferno:     { id: 'w_lame_inferno',     name: "Lame de l'Inferno",   rarity: 'mythique',   element: 'fire',   weaponType: 'blade',   atk: 33, bonusStat: 'crit_rate', bonusValue: 11,  icon: '\uD83D\uDDE1\uFE0F', desc: 'Forgee dans les flammes eternelles', sprite: 'https://api.builderberu.com/cdn/images/lameInferno_xutq4p.webp' },
  w_hache_volcanique: { id: 'w_hache_volcanique', name: 'Hache Volcanique',     rarity: 'legendaire', element: 'fire',   weaponType: 'heavy',   atk: 24, bonusStat: 'atk_pct',   bonusValue: 13, icon: '\uD83E\uDE93', desc: 'Lave solidifiee en acier', sprite: 'https://api.builderberu.com/cdn/images/HacheVolcanique_ifjtal.webp' },
  ...
  // Water (5)
  w_trident_abyssal:  { id: 'w_trident_abyssal',  name: 'Trident Abyssal',     rarity: 'mythique',   element: 'water',  weaponType: 'polearm', atk: 30, bonusStat: 'atk_pct',   bonusValue: 15, icon: '\uD83D\uDD31', desc: 'Arme des profondeurs', sprite: 'https://api.builderberu.com/cdn/images/TridentAbyssal_sdvheh.webp' },
  ...
  w_arc_tsunami:      { id: 'w_arc_tsunami',      name: 'Arc du Tsunami',       rarity: 'legendaire', element: 'water',  weaponType: 'ranged',  atk: 22, bonusStat: 'spd_flat',  bonusValue: 13, icon: '\uD83C\uDFF9', desc: 'Fleches de maree', scalingStat: 'int', sprite: 'https://api.builderberu.com/cdn/images/ArcTsunami_c2u6zk.webp' },
  ...
  w_griffe_nuit:      { id: 'w_griffe_nuit',      name: 'Griffe de la Nuit',    rarity: 'legendaire', element: 'shadow', weaponType: 'polearm', atk: 23, bonusStat: 'spd_flat',  bonusValue: 13, icon: '\uD83D\uDDE1\uFE0F', desc: "Rapide comme l'ombre", scalingStat: 'int', sprite: 'https://api.builderberu.com/cdn/images/GriffeNuit_uczxbi.webp' },
  ...
  // Neutral (3)
  w_epee_ancienne:    { id: 'w_epee_ancienne',    name: 'Epee Ancienne',        rarity: 'legendaire', element: null,     weaponType: 'blade',   atk: 22, bonusStat: 'atk_pct',   bonusValue: 11,  icon: '\u2694\uFE0F', desc: "Arme d'une ere oubliee", sprite: 'https://api.builderberu.com/cdn/images/EpeeAncienne_wsdywo.webp' },
  ...
  w_arc_celeste:      { id: 'w_arc_celeste',      name: 'Arc Celeste',          rarity: 'mythique',   element: 'light',  weaponType: 'ranged',  atk: 80,  bonusStat: 'spd_flat',  bonusValue: 18, icon: '\uD83C\uDFF9', desc: 'Lumiere purificatrice', scalingStat: 'int', ultime: true, sprite: 'https://api.builderberu.com/cdn/images/arcCeleste_i2ztc1.webp' },
  w_hache_ragnarok:   { id: 'w_hache_ragnarok',   name: 'Hache de Ragnarok',    rarity: 'mythique',   element: 'fire',   weaponType: 'heavy',   atk: 108, bonusStat: 'crit_dmg',  bonusValue: 23, icon: '\uFA62', desc: 'Forgee dans le feu du chaos', ultime: true, sprite: 'https://api.builderberu.com/cdn/images/HacheRagnarok_hj9z8e.webp' },
  ...
  w_sulfuras:         { id: 'w_sulfuras',         name: 'Masse de Sulfuras',    rarity: 'mythique',   element: 'fire',   weaponType: 'heavy',   atk: 250, bonusStat: 'atk_pct', bonusValue: 25, icon: '\uD83D\uDD28', sprite: 'https://api.builderberu.com/cdn/images/WeaponSulfuras_efg3ca.webp', desc: '???', secret: true, passive: 'sulfuras_fury', fireRes: 50, dropSource: 'Ragnarok', dropRate: '1/10,000' },
  // Secret — drop 1/5000 from Zephyr Ultime
  w_raeshalare:       { id: 'w_raeshalare',       name: "Rae'shalare, Murmure de la Mort", rarity: 'mythique', element: 'shadow', weaponType: 'ranged', atk: 200, bonusStat: 'crit_dmg', bonusValue: 25, icon: '\uD83C\uDFF9', sprite: 'https://api.builderberu.com/cdn/images/arc_d4t23d.webp', desc: 'Tire une fleche gemissante qui inflige des degats d\'Ombre et reduit les ennemis au silence', secret: true, passive: 'shadow_silence', darkRes: 50, dropSource: 'Zephyr Ultime', dropRate: '1/5,000' },
  // Secret — drop 1/50000 from Monarque Supreme
  w_katana_z:         { id: 'w_katana_z',         name: 'Katana Z',             rarity: 'mythique',   element: 'water', weaponType: 'blade',  atk: 260, bonusStat: 'spd_flat', bonusValue: 15, icon: '\u2694\uFE0F', sprite: 'https://api.builderberu.com/cdn/images/KatanaZ_pgth96.webp', desc: '+5% ATK permanent par coup. 50% contre-attaque (200% ATK).', secret: true, passive: 'katana_z_fury', darkRes: 40, dropSource: 'Monarque Supreme', dropRate: '1/50,000' },
  w_katana_v:         { id: 'w_katana_v',         name: 'Katana V',             rarity: 'mythique',   element: 'light', weaponType: 'blade',  atk: 120, bonusStat: 'int_pct', bonusValue: 25, icon: '\u2694\uFE0F', sprite: 'https://api.builderberu.com/cdn/images/KatanaV_zv4oke.webp', desc: 'Katana du chaos. Scale sur INT/Mana. Empoisonne, buff et protege.', secret: true, passive: 'katana_v_chaos', darkRes: 35, dropSource: 'Monarque Supreme', dropRate: '1/50,000' },
  // Secret — drop 1/80,000 from Archdemon (cumulative pity)
  w_guldan:            { id: 'w_guldan',            name: "Baton de Gul'dan",      rarity: 'mythique',   element: 'wind',  weaponType: 'staff',  atk: 180, bonusStat: 'spd_flat', bonusValue: 20, baseDef: 50, windRes: 10, icon: '\uD83E\uDE84', sprite: 'https://api.builderberu.com/cdn/images/batonGuldan_vuu7ez.webp', projectile: 'https://api.builderberu.com/cdn/images/projectileGuldan_ii184b.webp', desc: "Baton maudit du demon Gul'dan. Un halo eternel protege et renforce son porteur.", secret: true, passive: 'guldan_halo', dropSource: 'Archdemon', dropRate: '1/80,000' },
