...
const DamageCalculator = ({
  ...
  // Boss presets
  const bossPresets = {
    fatchna: { name: 'Fatchna', level: 80, defense: 248000, cp: 50000, img: 'https://api.builderberu.com/cdn/images/fatchna_npzzlj.webp' },
    antQueen: { name: 'Ant Queen', level: 82, defense: 150000, cp: 50000, img: 'https://api.builderberu.com/cdn/images/antQueen_jzt22r.webp' },
    ennioImmortal: { name: 'Ennio Immortal', level: 82, defense: 1500000, cp: 50000, img: 'https://api.builderberu.com/cdn/images/ennioimmortal_t86t1w.webp' },
    custom: { name: 'Custom', level: 80, defense: 100000, cp: 100000, img: 'https://api.builderberu.com/cdn/images/jinahcustom_id8cwq.webp' }
  };
      ...
      <div className={`bg-indigo-950/90 backdrop-blur-md rounded-lg shadow-2xl shadow-indigo-900/50 w-full ${isMobile ? 'max-w-md max-h-[90vh] overflow-y-auto' : 'max-w-5xl'}`}>
        ...
        <div className={`${isMobile ? 'p-3 space-y-3' : 'grid grid-cols-3 gap-3 p-3'}`}>
          ...
          <div className="space-y-2">
            ...
            <div className="bg-indigo-900/20 rounded p-2">
              <div className="flex items-center justify-between mb-1.5">
                <div className="flex items-center gap-2">
                  <img loading="lazy" src="https://api.builderberu.com/cdn/images/sungicon_bfndrc.webp" alt="icon" className="w-4 h-4 rounded" />
            ...
            <div className="bg-indigo-900/20 rounded p-2">
              <div className="flex items-center gap-2 mb-1.5">
                <img loading="lazy" src="https://api.builderberu.com/cdn/images/jinahlogo_lllt2d.webp" alt="icon" className="w-4 h-4 rounded" />
            ...
            <div className="bg-indigo-900/20 rounded p-2">
              <div className="flex items-center gap-2 mb-1.5">
                <img loading="lazy" src="https://api.builderberu.com/cdn/images/chaelogo_hci0do.webp" alt="icon" className="w-4 h-4 rounded" />
          ...
          <div className="space-y-2">
            ...
            <div className="bg-indigo-900/20 rounded p-2">
              <div className="flex items-center gap-2 mb-1.5">
                <img loading="lazy" src="https://api.builderberu.com/cdn/images/bossConfig_ftvd3z.webp" alt="icon" className="w-4 h-4 rounded" />
          ...
          <div className="space-y-2">
            ...
            <div className="bg-indigo-900/20 rounded p-2">
              <div className="flex items-center gap-2 mb-1.5">
                <img loading="lazy" src="https://api.builderberu.com/cdn/images/beruProst_ymvwos.webp" alt="icon" className="w-4 h-4 rounded" />
